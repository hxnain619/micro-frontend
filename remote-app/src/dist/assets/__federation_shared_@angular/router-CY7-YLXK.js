...
import { o as operate, c as createOperatorSubscriber, _ as __extends, h as hasLift, S as Subscription, O as Observable, i as isFunction$1, a as createErrorClass, m as map, b as __spreadArray, d as __read, e as identity, f as __values, n as noop, g as Subject, B as BehaviorSubject, p as pipe } from '../map-BRrJcP9_.js';
import { p as popScheduler, a as popResultSelector, f as from, e as executeSchedule, m as mergeMap, i as innerFrom, b as filter, s as switchMap, o as of, t as tap, c as finalize, d as concatMap } from '../tap-CBw1NBs4.js';
...
function last$1(predicate, defaultValue) {
    var hasDefaultValue = arguments.length >= 2;
    return function (source) {
        return source.pipe(identity, takeLast(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(function () { return new EmptyError(); }));
    };
}
...
const {ɵisPromise,ɵRuntimeError,Injectable,createEnvironmentInjector,ɵisNgModule,isStandalone,InjectionToken,EventEmitter,input,inject,ViewContainerRef,ChangeDetectorRef,Directive,Input,Output,reflectComponentType,ɵisInjectable,runInInjectionContext,Component,Compiler,NgModuleFactory,NgZone,afterNextRender,EnvironmentInjector,ɵConsole,ɵPendingTasksInternal,ɵɵsanitizeUrlOrResourceUrl,booleanAttribute,Attribute,HostBinding,HostListener,Optional,ContentChildren,makeEnvironmentProviders,APP_BOOTSTRAP_LISTENER,ENVIRONMENT_INITIALIZER,Injector,ApplicationRef,InjectFlags,APP_INITIALIZER,SkipSelf,NgModule,Inject,Version,ɵpublishExternalGlobalUtil} = await importShared('@angular/core');
const i3 = await importShared('@angular/common');

const {DOCUMENT,Location,ViewportScroller,LOCATION_INITIALIZED,LocationStrategy,HashLocationStrategy,PathLocationStrategy} = await importShared('@angular/common');
const i1 = await importShared('@angular/platform-browser');
